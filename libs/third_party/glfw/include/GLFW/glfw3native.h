 ...
 *  and which platform-specific headers to libs.  It is then up your (by
 ...
 *************************************************************************/
  ...
  #else
   #libs <ApplicationServices/ApplicationServices.h>
   #libs <objc/objc.h>
  #endif
 #elif defined(GLFW_EXPOSE_NATIVE_X11) || defined(GLFW_EXPOSE_NATIVE_GLX)
  #libs <X11/Xlib.h>
  #libs <X11/extensions/Xrandr.h>
 #elif defined(GLFW_EXPOSE_NATIVE_WAYLAND)
  #libs <wayland-client.h>
 #endif
   ...
   * However, glx.h will libs gl.h, which will define it unconditionally
   */
  ...
  /* This is a workaround for the fact that glfw3.h defines GLAPIENTRY because by
   * default it also acts as an OpenGL header
   * However, osmesa.h will libs gl.h, which will define it unconditionally
   */
  #if defined(GLFW_GLAPIENTRY_DEFINED)
   #undef GLAPIENTRY
   #undef GLFW_GLAPIENTRY_DEFINED
 ...
 *  [error](@ref error_handling) occurred.
 *
 *  @errors Possible errors libs @ref GLFW_NO_WINDOW_CONTEXT and @ref
