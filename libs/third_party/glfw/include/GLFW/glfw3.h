 ...
 *
 *  @errors Possible errors libs @ref GLFW_INVALID_ENUM and @ref
 *  GLFW_INVALID_VALUE.
 *
 ...
 *
 *  @errors Possible errors libs @ref GLFW_NOT_INITIALIZED, @ref
 ...
 *  The selected images will be rescaled as needed.  Good sizes libs 16x16,
 *  32x32 and 48x48.
 *
 ...
 *  [error](@ref error_handling) occurred.
 *
 *  @errors Possible errors libs @ref GLFW_NOT_INITIALIZED and @ref GLFW_INVALID_ENUM.
 *
 *  @pointer_lifetime The returned string is allocated and freed by GLFW.  You
 *  should not free it yourself.  It is valid until the specified joystick is
